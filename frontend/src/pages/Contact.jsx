                    ...
                    <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        ...
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            <ul className="leading-relaxed flex space-x-4 mt-1">
                                <li>
                                    <a href="https://fb.com/abir.upwork" target="_blank">
                                        <FontAwesomeIcon icon={faFacebookF} />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://bd.linkedin.com/in/asif-abir-5a5a5927b" target="_blank">
                                        <FontAwesomeIcon icon={faLinkedinIn} />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://github.com/asif-daffodil" target="_blank">
                                        <FontAwesomeIcon icon={faGithub} />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/@abir.upwork" target="_blank">
